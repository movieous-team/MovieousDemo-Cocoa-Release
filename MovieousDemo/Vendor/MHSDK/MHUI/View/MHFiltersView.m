...
- (__kindof UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
     MHFilterCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"MHFilterCell" forIndexPath:indexPath];
       cell.filtermodel = self.array[indexPath.row];
       return cell;
}
...
- (UICollectionView *)collectionView {
    if (!_collectionView) {
        ...
        [_collectionView registerClass:[MHFilterCell class] forCellWithReuseIdentifier:@"MHFilterCell"];
    }
