...
- (void)setupViews {
    ...
    STButton *backBtn = [[STButton alloc] initWithFrame:CGRectMake(12, 52, 7, 11)];
    ...
    leftView.frame = CGRectMake(24, 30, 33, 60);
    _leftView = leftView;
    [self addSubview:leftView];
    
    STFilterCollectionView *filterCollectionView = [[STFilterCollectionView alloc] initWithFrame:CGRectMake(CGRectGetMaxX(leftView.frame) + 20, 0, self.frame.size.width - 77, 134) withModels:nil andDelegateBlock:nil];
