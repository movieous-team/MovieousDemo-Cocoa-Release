...
// by movieous
@property(nonatomic, strong, readonly) UIView *beautifyFilterView;
@property(nonatomic, strong, readonly) UIView *stickerMenuView;
@property(nonatomic, strong, readonly) UIView *distortionMenuView;
@property(nonatomic, strong, readonly) UIView *beautifyNewView;
@property(nonatomic, strong, readonly) UIView *slideBeautifyMenuView;
@property(nonatomic, strong, readonly) UIView *filterGlobalView;
@property(nonatomic, strong, readonly) UIScrollView *mainMenuView;
@property(nonatomic, strong, readonly) UILabel *smiliesStateText;
