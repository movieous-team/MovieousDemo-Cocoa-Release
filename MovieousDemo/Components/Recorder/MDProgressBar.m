...
- (void)setLastProgressStyle:(MDProgressBarProgressStyle)lastProgressStyle {
    ...
    switch (lastProgressStyle) {
        case MDProgressBarProgressStyleDelete:
        {
            lastProgressView.backgroundColor = [UIColor redColor];
            _progressIndicator.hidden = YES;
        }
            break;
        case MDProgressBarProgressStyleNormal:
        {
...
- (void)deleteLastProgress {
    _lastProgressStyle = MDProgressBarProgressStyleNormal;
    UIView *lastProgressView = [_progressViewArray lastObject];
    if (!lastProgressView) {
        return;
    }
